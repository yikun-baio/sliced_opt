...
optimizer1=optim.SGD([scalar],lr=0.05,momentum=0.1)
optimizer2=optim.SGD([theta],lr=0.2,momentum=0.1)
...
for epoch in range(n_iteration):
    ...
    if epoch%10==0 or epoch<=50:
      ...
      plt.savefig('experiment/shape_registration/result/exp1/sopt/'+str(epoch)+'.jpg')
      #plt.show()
      #plt.close()
...
torch.save(paramlist,'experiment/shape_registration/result/exp1/sopt_param.pt')
torch.save(errlist,'experiment/shape_registration/result/exp1/sopt_err.pt')
